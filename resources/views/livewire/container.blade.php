    ...
    <div class="container m-[auto] mt-8">
        <div class="grid">
            ...
            <div>
                                            ...
                                            <td class="p-4">
                                                <div class="flex">
                                                    @if($container->state == 'running')
                                                        <div class="contents cursor-pointer" wire:click="stopContainer('{{$container->container_id}}')">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                                                                <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25v13.5m-7.5-13.5v13.5" />
                                                            </svg>
                                                        </div>
                                                    @else
                                                        <div class="contents cursor-pointer" wire:click="startContainer('{{$container->container_id}}')">
                ...
                @else
                <div>
                    <h1 class="text-4xl text-center">Docker is not started or you haven't created any Databse container</h1>
                </div>
                @endif
            </div>
        </div>
